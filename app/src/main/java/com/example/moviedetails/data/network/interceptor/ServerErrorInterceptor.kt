package com.example.moviedetails.data.network.interceptor

import android.content.Context
import com.example.moviedetails.data.network.ErrorType
import com.example.moviedetails.data.network.exception.ServerErrorException
import com.example.moviedetails.data.network.exception.UnexpectedServerErrorException
...
class ServerErrorInterceptor(private val context: Context) : Interceptor {
    ...
    private fun createBadRequestError(): ServerErrorException = ServerErrorException(
